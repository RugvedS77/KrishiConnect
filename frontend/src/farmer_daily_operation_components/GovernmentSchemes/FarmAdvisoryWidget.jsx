...
function FarmAdvisoryWidget() {
    ...
    if (error) {
        return <div className="p-5 text-red-600 h-full flex items-center justify-center">Error: {error}</div>;
    }
        ...
        <div className="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden h-full flex flex-col">
            <div className="flex flex-col lg:flex-row flex-grow">
                ...
                <div className="flex-shrink-0 p-6 lg:w-1/3 bg-gradient-to-br from-blue-400 to-blue-600 text-white flex flex-col justify-center">
                    <h3 className="text-xl font-semibold mb-4 text-white">Current Conditions</h3>
                    <div className="flex items-center justify-between gap-4">
                    ...
                    <div className="space-y-3">
                        <div className="flex items-center gap-3 text-blue-100">
                           <svg className="w-5 h-5 opacity-80 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
                                <path strokeLinecap="round" strokeLinejoin="round" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4" />
                            </svg>
                        ...
                        <div className="flex items-center gap-3 text-blue-100">
                           <svg className="w-5 h-5 opacity-80 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
                                <path strokeLinecap="round" strokeLinejoin="round" d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6h.1a5 5 0 011 9.9M9 19l3 3m0 0l-3-3m-3 3V10" />
                            </svg>
                ...
                <div className="flex-grow p-6">
                    ...
                    <div className="space-y-4">
                        {insights.map((insight, index) => {
                            ...
                            return (
                                <div key={index} className={`flex items-start gap-4 p-4 rounded-lg border-l-4 ${bgColor} transition-all duration-200 hover:shadow-md hover:-translate-y-0.5 hover:border-gray-400`}>
