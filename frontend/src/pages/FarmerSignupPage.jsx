// src/pages/FarmerSignupPage.jsx

import React, { useState } from "react";
// FIX: Removed Router, Routes, and Route as they are now handled by your main app router.
import { Link, useNavigate } from "react-router-dom";
import { User, Mail, Lock, Leaf } from "lucide-react";

// --- Reusable SVG Icons (Can be moved to a shared file later) ---
const GoogleIcon = () => (
...
const FarmerSignupPage = () => {
  ...
  const handleSignup = async (e) => {
    ...
    // Assumes the backend expects a JSON body for user creation
    const userData = {
      full_name: full_name,
      email: email,
      password: password,
      role: "farmer" // Assuming you set the role on signup
    };
...
// FIX: Export the FarmerSignupPage directly.
