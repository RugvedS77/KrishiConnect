...
const GoogleIcon = () => (
  ...
  >
       {" "}
    <path
      d="M22.56 12.25C22.56 11.45 22.49 10.68 22.36 9.94H12V14.28H17.96C17.67 15.63 17.03 16.8 16.14 17.48V20.2H19.83C21.66 18.57 22.56 15.69 22.56 12.25Z"
      fill="#4285F4"
    />
       {" "}
    <path
      d="M12 23C14.97 23 17.45 22.04 19.28 20.2L16.14 17.48C15.15 18.14 13.67 18.57 12 18.57C9.31 18.57 6.99 16.81 6.09 14.39H2.38V17.21C4.18 20.79 7.8 23 12 23Z"
      fill="#34A853"
    />
       {" "}
    <path
      d="M6.09 14.39C5.83 13.68 5.69 12.92 5.69 12.14C5.69 11.36 5.83 10.6 6.09 9.89V7.07H2.38C1.5 8.7 1 10.36 1 12.14C1 13.92 1.5 15.58 2.38 17.21L6.09 14.39Z"
      fill="#FBBC05"
    />
       {" "}
    <path
      d="M12 5.43C13.43 5.43 14.67 5.9 15.6 6.78L18.42 4.14C16.63 2.52 14.47 1.5 12 1.5C7.8 1.5 4.18 3.71 2.38 7.07L6.09 9.89C6.99 7.47 9.31 5.43 12 5.43Z"
      fill="#EA4335"
    />
     {" "}
  </svg>
...
const MicrosoftIcon = () => (
  ...
  >
    ...
       {" "}
    <path
      d="M21.3292 12.0498H12.2792V21.0998H21.3292V12.0498Z"
      fill="#FFB900"
    />
     {" "}
  </svg>
...
const FarmerSignupPage = () => {
  const navigate = useNavigate(); // --- State (Unchanged) ---
  const [full_name, setName] = useState("");
  const [email, setEmail] = useState("");
  const [password, setPassword] = useState("");
  const [error, setError] = useState(null);
  const [success, setSuccess] = useState(null);
  const [isLoading, setIsLoading] = useState(false); // --- Handle API Signup (Unchanged) ---
  ...
  return (
    ...
    <div className="min-h-screen flex items-center justify-center p-4 bg-gradient-to-br from-green-600 to-gray-900">
      ...
      <div className="w-full max-w-md bg-white rounded-2xl shadow-2xl p-8 sm:p-12">
                        {/* 2. CHANGE HERE: Logo icon changed to green */}     
         {" "}
        ...
        <form onSubmit={handleSignup} className="space-y-6">
          ...
          <div>
            ...
            <div className="relative mt-1">
              ...
              {/* 4. CHANGE HERE: Focus ring changed to green */}
                           {" "}
              <input
                type="email"
