...
// Removed ArrowRight as it's not used in this version
...
const BuyerLoginPage = () => {
  ...
  return (
    // --- Full Screen Centering Container with Gradient "Shade" ---
    <div
    ...
    >
      ...
      <div className="w-full max-w-md bg-white rounded-2xl shadow-2xl p-8 sm:p-12">
        ...
        <form onSubmit={handleLogin} className="space-y-6">
          ...
          <button
            type="submit"
            className="w-full bg-green-600 text-white font-bold py-3 px-4 rounded-lg hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 transition-all duration-300 shadow-lg hover:shadow-green-500/30"
          >
            Log In
          </button>
        </form>
