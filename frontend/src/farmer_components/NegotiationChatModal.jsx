        ...
        const connect = async () => {
            try {
                ...
                socket.onmessage = (event) => {
                    ...
                    // If the message is a new offer AND you are not the sender
                    if (messageData.type === 'NEW_OFFER' && messageData.sender_id !== user.id) {
                        // Trigger a toast notification
                        toast.info(`You have a new offer from ${messageData.senderName}!`);
                    }
