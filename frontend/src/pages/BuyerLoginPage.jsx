  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      if (role === 'buyer') {
        ...
        setError("This account does not have buyer permissions.");
        useAuthStore.getState().logout(); // Log them out
      }
    } catch (err) {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 bg-gradient-to-br from-green-600 to-gray-900">
      <div className="w-full max-w-md bg-white rounded-2xl shadow-2xl p-8 sm:p-12">
        ...
        {/* --- 4. FORM UPDATED TO BE CONTROLLED --- */}
        ...
        {/* Social Login & Sign Up (Unchanged) */}
        ...
        <p className="text-center text-sm text-gray-600 mt-8">
          ...
          <Link to="/signup-buyer" className="font-medium text-green-600 hover:text-green-700 hover:underline transition-colors">
            Sign Up
          </Link>
        </p>
      </div>
